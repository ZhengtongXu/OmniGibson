...
class FrankaPandaDummy(ManipulationRobot):
    """
    ...
    def eef_link_names(self):
        return {self.default_arm: "panda_eef"}
    ...
    @property
    def usd_path(self):
        return os.path.join(gm.ASSET_PATH, "models/franka/franka_panda_dummy.usd")
    
    @property
    def robot_arm_descriptor_yamls(self):
        return {self.default_arm: os.path.join(gm.ASSET_PATH, "models/franka/franka_panda_dummy_description.yaml")}
    
    @property
    def urdf_path(self):
        return os.path.join(gm.ASSET_PATH, "models/franka/franka_panda_dummy.urdf")
    ...
    def get_original_eef_position(self, arm="default"):
        """
        Args:
        ...
        Returns:
            3-array: (x,y,z) global end-effector Cartesian position for this robot's end-effector corresponding
                to arm @arm
        """
        link_names = {self.default_arm: "panda_hand"}
        arm = self.default_arm if arm == "default" else arm
        return self._links[link_names[arm]].get_position()

    def get_original_eef_orientation(self, arm="default"):
        """
        Args:
        ...
        link_names = {self.default_arm: "panda_hand"}
        arm = self.default_arm if arm == "default" else arm
        return self._links[link_names[arm]].get_orientation()